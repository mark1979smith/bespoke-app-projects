...
class FormTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp() {
        $this->testForm = new Form(self::formNamespace(), self::formData());
    }
    ...
    public function testGetFields()
    {
         ...
         * Assert Pass
         */
        $this->assertEquals($this->testForm->getFields(), self::formData());

        /**
         * Assert Failures
         */
        $test_fields = $this->testForm->getFields();
        $this->assertNotEquals(array_pop($test_fields), self::formData());
    }

    protected static function formNamespace()
    {
        return 'enquiry';
    }

    protected static function formData()
    {
        return [
            'name' => [
                'rqd' => true,
